        ...
        position: function(t) {
            ...
            return this.options.constraints.forEach(function(t) {
                ...
                if (a.indexOf(" ") >= 0) {
                    ...
                    h = d = a;
                var b = O(e, r);
                ("target" === d || "both" === d) && (o < b[1] && "top" === v.top && (o += u,
                    v.top = "bottom"),
                o + s > b[3] && "bottom" === v.top && (o -= u,
                    v.top = "top")),
                "together" === d && ("top" === v.top && ("bottom" === y.top && o < b[1] ? (o += u,
                    v.top = "bottom",
                    o += s,
                    y.top = "top") : "top" === y.top && o + s > b[3] && o - (s - u) >= b[1] && (o -= s - u,
                    v.top = "bottom",
                    y.top = "bottom")),
                "bottom" === v.top && ("top" === y.top && o + s > b[3] ? (o -= u,
                    v.top = "top",
                    o -= s,
                    y.top = "bottom") : "bottom" === y.top && o < b[1] && o + (2 * s - u) <= b[3] && (o += s - u,
                    v.top = "top",
                    y.top = "top")),
    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery)
        ...
        return babelHelpers.createClass(_class, [{
            ...
            value: function() {
                for (var _this = this, self = this, keys = Object.keys(this._states), obj = {}, tmpRelations = [], composites = [], _loop = function(i, l) {
                    ...
                    "function" != typeof value ? (Object.defineProperty(obj, key, {
                        ...
                        _this._relations[key] = []) : composites.push(key)
                ...
                for (var _loop2 = function(_i, _l) {
                    ...
                    Object.defineProperty(obj, key, {
                        ...
                        obj[key]
                }, _i = 0, _l = composites.length; _i < _l; _i++)
                    _loop2(_i, _l)
            }
        }, {
            key: "_compare",
            ...
            value: function(state) {
                ...
                if (relations && relations.length > 0)
                    for (var i = 0, l = relations.length; i < l; i++) {
                        ...
                        value !== this._values[_state] && (this._dispatch(_state, this._values[_state], value),
            ...
            value: function(state, callback) {
                "function" == typeof state && (callback = state,
                    state = "all"),
            ...
            value: function(state, value) {
                ...
                if ("string" == typeof state && "undefined" != typeof value && "function" != typeof this._states[state])
                    this._states[state] = value,
                    isDeep || this._compare(state);
                else if ("object" === ("undefined" == typeof state ? "undefined" : babelHelpers.typeof(state))) {
                    for (var _key in state)
                        "function" != typeof state[_key] && this.set(_key, state[_key], !0);
                    for (var _key2 in state)
                        "function" != typeof state[_key2] && this._compare(_key2)
                }
...
!function(global, factory) {
    ...
    var _class = function() {
        function _class() {
            ...
            babelHelpers.classCallCheck(this, _class),
                this.$el = options.$el ? options.$el : (0,
                    _jquery2.default)(document),
                this.el = this.$el[0],
                delete options.$el,
            ...
            value: function() {
                var _this = this
                    ...
                    "function" == typeof action ? _this.state.on(state, function() {
                        for (var _actions$state, _len = arguments.length, params = Array(_len), _key = 0; _key < _len; _key++)
                        ...
                        for (var _action, _len2 = arguments.length, params = Array(_len2), _key2 = 0; _key2 < _len2; _key2++)
...
!function(global, factory) {
    ...
    function pluginFactory(name, $el) {
        ...
        if (PluginClass && "undefined" == typeof PluginClass.api)
            return new PluginClass($el,_jquery2.default.extend(!0, {}, getDefaults(name), options));
    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery)
        ...
        return babelHelpers.createClass(Plugin, [{
            ...
            value: function(name, obj) {
                "undefined" != typeof obj && (plugins[name] = obj,
                "undefined" != typeof obj.api && Plugin.registerApi(name, obj))
            }
        }, {
            key: "registerApi",
            value: function(name, obj) {
                ...
                "string" == typeof api ? !function() {
                    var api = obj.api().split("|")
                        ...
                        plugin || (plugin = new obj($el,_jquery2.default.extend(!0, {}, getDefaults(name), $el.data())),
                            plugin.initialize(),
                    ...
                    apis[name] = function(selector, context) {
                        context ? ((0,
                            _jquery2.default)(context).off(event),
                            (0,
                                _jquery2.default)(context).on(event, selector, callback)) : (0,
                            _jquery2.default)(selector).on(event, callback)
                    }
        ...
        return babelHelpers.inherits(_class, _Component),
            babelHelpers.createClass(_class, [{
                ...
                value: function() {
                    ...
                    (0,
                        _jquery2.default)("[data-plugin]", context || this.$el).each(function() {
                        var $this = (0,
                            _jquery2.default)(this)
                            , name = $this.data("plugin")
                            , plugin = (0,
                            _Plugin.pluginFactory)(name, $this, $this.data());
                ...
                value: function() {
                    var context = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document
                        , apis = (0,
                        _Plugin.getPluginAPI)();
                    for (var name in apis)
                        (0,
                            _Plugin.getPluginAPI)(name)("[data-plugin=" + name + "]", context)
                }
            }]),
            _class
    }(_Component3.default);
...
!function(global, factory) {
    ...
    function get() {
        for (var data = values, callback = function(data, name) {
            return data[name]
        }, _len = arguments.length, names = Array(_len), _key = 0; _key < _len; _key++)
    ...
    function getColor(name, level) {
        if ("primary" === name && (name = get("primaryColor"),
        name || (name = "red")),
        "undefined" == typeof values.colors)
            return null;
        if ("undefined" != typeof values.colors[name]) {
            if (level && "undefined" != typeof values.colors[name][level])
...
!function(global, factory) {
    if ("function" == typeof define && define.amd)
        define("/Site", ["exports", "jquery", "Config", "Base"], factory);
    else if ("undefined" != typeof exports)
            ...
            babelHelpers.createClass(Site, [{
                ...
                value: function() {
                    $DOC.tooltip({
                        ...
                        (0,
                            _jquery2.default)('[data-toggle="tooltip"]').tooltip(),
                        (0,
                            _jquery2.default)('[data-toggle="popover"]').popover()
                }
            }, {
                key: "polyfillIEWidth",
                value: function() {
                ...
                value: function() {
                    ...
                    screenfull.enabled && DOC.addEventListener(screenfull.raw.fullscreenchange, function() {
                        (0,
                            _jquery2.default)('[data-toggle="fullscreen"]').toggleClass("active", screenfull.isFullscreen)
                    }))
                }
            }, {
                key: "setupMegaNavbar",
                value: function() {
                    $DOC.on("click", ".navbar-mega .dropdown-menu", function(e) {
                        ...
                        var $target = (0,
                            _jquery2.default)(e.target)
                            , $trigger = e.relatedTarget ? (0,
                            _jquery2.default)(e.relatedTarget) : $target.children('[data-toggle="dropdown"]')
                        ...
                        var $menu = (0,
                            _jquery2.default)(e.target).find(".dropdown-menu-media > .list-group");
                        if ($menu.length > 0) {
                ...
                value: function(flag) {
                    ...
                    if ("undefined" == typeof this.tour) {
                        var _ret2 = function() {
                            ...
                            var overflow = (0,
                                _jquery2.default)("body").css("overflow")
                                , self = _this3
                                , tourOptions = Config.get("tour");
                            _this3.tour = introJs(),
                                _this3.tour.onbeforechange(function() {
                                    (0,
                                        _jquery2.default)("body").css("overflow", "hidden")
                                }),
                                _this3.tour.oncomplete(function() {
                                    (0,
                                        _jquery2.default)("body").css("overflow", overflow)
                                }),
                                ...
                                (0,
                                    _jquery2.default)(".site-tour-trigger").on("click", function() {
                                    self.tour.start()
                                })
                        }();
                        if ("object" === ("undefined" == typeof _ret2 ? "undefined" : babelHelpers.typeof(_ret2)))
                            return _ret2.v
                    }
                }
            }]),
...
!function(t, n) {
    ...
    var r = function() {
        ...
        , a = {
            each: function(t, n) {
                var e = void 0;
                for (var i in t)
                    if (("object" !== ("undefined" == typeof t ? "undefined" : o(t)) || t.hasOwnProperty(i)) && (e = n(i, t[i]),
                    e === !1))
                        break
            },
            ...
            return r(t, [{
                ...
                value: function(t) {
                    for (var n = 0; n < this.list.length; n++)
                        this.list[n].fn === t && (this.list.splice(n, 1),
                            this.length--,
                            n--)
                }
            }, {
        ...
        , f = {
            ...
            trigger: function(t) {
                var n = this.current;
                this.current = t,
                    this.callbacks.fire(t, function(e, i) {
            ...
            on: function(t, n) {
                var e = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                "undefined" == typeof n && a.isFunction(t) && (n = t,
                    t = void 0),
        ...
        , c = function() {
            ...
            return r(t, [{
                ...
                value: function(t, n, e) {
                    ...
                    return "undefined" == typeof e && a.isFunction(n) && (e = n,
                        n = void 0),
                        a.isFunction(e) ? ("undefined" != typeof this.callbacks[t] && (this.callbacks[t].add(e, n, i),
                        "enter" === t && this.isMatched() && this.callbacks[t].call(this)),
                            this) : this
                }
            }, {
                key: "one",
                ...
                value: function(t, n) {
                    ...
                    return "undefined" == typeof t ? (this.callbacks.enter.empty(),
    ...
    m.defaults = s,
        m = a.extend(m, {
            ...
            getUnion: function(t) {
                return y.hasOwnProperty(t) ? y[t] : (y[t] = new d(t),
                    y[t])
            },
            getMin: function(t) {
                var n = this.get(t);
...
if (met_lazyloadbg.indexOf(M['weburl']) < 0 && met_lazyloadbg.indexOf('http') < 0 && met_lazyloadbg.indexOf('../') < 0)
    met_lazyloadbg = M['weburl'] + met_lazyloadbg;
if (met_lazyloadbg == M['weburl'] || (met_lazyloadbg.indexOf('.png') < 0 && met_lazyloadbg.indexOf('.gif') < 0 && met_lazyloadbg.indexOf('.jpg') < 0))
    met_lazyloadbg = M['weburl'] + 'public/ui/v2/static/img/loading.gif';
if (!!window.ActiveXObject || 'ActiveXObject'in window || M['is_ucbro'])
    met_lazyloadbg = 'base64';
...
(function(document, window, $) {
        ...
        $(function() {
            ...
            $(document).on('click', '.modal-dialog.modal-center', function(e) {
                if (!$(e.target).closest(".modal-dialog.modal-center .modal-content").length && $('.modal-backdrop').length)
            ...
            Breakpoints.on('xs', {
                enter: function() {
                    $(document).on('show.bs.modal', '.modal', function(event) {
                        if ($('.modal-dialog', this).hasClass('modal-center'))
                            $('.modal-dialog', this).removeClass('modal-center');
                    });
                }
            })
            // 弹窗高度过高时，其位置取消垂直居中
            $(document).on('shown.bs.modal', '.modal', function(event) {
                if ($('.modal-dialog', this).hasClass('modal-center') && $('.modal-content', this).height() > $(window).height())
                    $('.modal-dialog', this).removeClass('modal-center');
            });
        })
    }
    ...
    includeFile: function(file, num_start, num_end, fun, special) {
        ...
        if (includeFileIndex >= num_start && includeFileIndex < num_end) {
            if (ext[0] == 'js') {
                ...
                if (!$('link[href="' + href + '"]').length && typeof filesi != "undefined")
...
$(function() {
    ...
    if ($('.met-editor iframe,.met-editor embed').length)
        $('.met-editor iframe,.met-editor embed').videoSizeRes();
});
// 全局函数
$.fn.extend({
        ...
        var $self = $(this)
            ...
            if (navObjW > $self.parent().width()) {
                ...
                if ($self.hasClass('swiper-wrapper')) {
                    if (!$self.hasClass('flex-start'))
                        $self.addClass('flex-start');
                } else {
                ...
                if ($navObj_p.length && $('.product-search').length)
                    $navObj_p.height('auto').css({
                        'margin-bottom': 10
                    });
                // 下拉菜单被隐藏特殊情况处理
                if ($self.find('.dropdown').length && $(".swiper-navtab").length) {
                    if (!$(".swiper-navtab").hasClass('overflow-visible'))
    ...
    imageSize: function(imgObj) {
        ...
        $(this).each(function() {
            ...
            if ($img.length && scale.indexOf('x') >= 0) {
                ...
                $(window).resize(function() {
                    $img.each(function() {
                        if ($(this).is(':visible') && $(this).data('original') && $(this).attr('src') != $(this).data('original'))
                            $(this).height(Math.round($(this).width() * scale));
                    })
                });
                // 图片高度删除
                $img.each(function() {
    ...
    videoSizeRes: function() {
        $(this).each(function() {
            var $self = $(this)
                ...
                , width = $(this).width();
            if (!scale)
                scale = parseInt($(this).css('height')) / parseInt($(this).css('width'));
            if (scale) {
                ...
                $self.each(function() {
                    if (!$('thead', this).length) {
                        var td = $("tbody tr:eq(0) td", this)
                            , th = '';
                        if (td.length == 0)
                            td = $("tbody tr:eq(0) th", this);
                        td.each(function() {
                            th += $(this).prop('outerHTML');
                        });
                        if (th.indexOf('</td>') >= 0)
                            th = th.replace(/<\/td>/g, '</th>');
                        if (th.indexOf('<td') >= 0)
                            th = th.replace(/<td/g, '<th');
